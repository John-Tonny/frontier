...
> [Subtrate node template release process](https://github.com/John-Tonny/substrate/blob/master/docs/node-template-release.md) -
...
4.  There are actually two packages in the Node Template, `frontier-node-template` (the node),
    ...
    remote repository, such as:
        ...
        git = 'https://github.com/John-Tonny/substrate.git'
